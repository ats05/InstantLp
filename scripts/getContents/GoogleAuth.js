...
const CREDENTIAL_PATH = __dirname + '/../../credentials/credentials.json';
const OUTPUT_PATH = __dirname + '/../../contents/docx/';
...
module.exports = class GoogleAuth{
    ...
    constructor(){
        ...
        this.oAuthClient = this.authorize(JSON.parse(credential));
    }
